...
def model_opts(parser):
    ...
    group.add('--encoder_type', '-encoder_type', type=str, default='rnn',
              choices=['rnn', 'brnn', 'mean', 'transformer', 'cnn', 'gat'],
...
def gat_opts(parser):
    ...
    group.add_argument('-gat_num_inputs', type=int, default=500,
                       help='Input size for the gat layer')
    group.add_argument('-gat_num_units', type=int, default=500,
                       help='Output size for the gat layer')
    group.add_argument('-gat_num_labels', type=int, default=5,
                       help='Number of labels for the edges of the gat layer')
    group.add_argument('-gat_num_layers', type=int, default=1,
                       help='Number of gat layers')
    group.add_argument('-gat_in_arcs', action="store_true",
                       help='Use incoming edges of the gat layer')
    group.add_argument('-gat_out_arcs', action="store_true",
                       help='Use outgoing edges of the gat layer')
    group.add_argument('-gat_batch_first', action="store_true",
                       help='Batchfirst for the gat layer')
    group.add_argument('-gat_residual', type=str, default="",
                       choices=['residual', 'dense'],
                       help='Ddcide wich skip connection to use between gat layers')
    group.add_argument('-gat_use_gates', action="store_true",
                       help='Switch to activate edgewise gates')
    group.add_argument('-gat_use_glus', action="store_true",
                       help='Node gates.')
...
def translate_opts(parser):
    ...
    group.add_argument('-src_label', required=False,
                       help="Path to the test source data gat")
